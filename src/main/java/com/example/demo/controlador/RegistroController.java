...
public class RegistroController {
    ...
    public String registrarUsuario(@Valid Usuario usuario, BindingResult result, Model model, RedirectAttributes redirectAttributes) {
        if (result.hasErrors()) {
            return "formulario_registro"; // tu vista de registro
        }
