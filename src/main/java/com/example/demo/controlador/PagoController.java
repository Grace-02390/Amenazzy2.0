...
public class PagoController {
     ...
     */
    @GetMapping("/pago")
    public String showPaymentPage(@RequestParam("metodo") String metodo, Model model, HttpSession session, RedirectAttributes redirectAttributes) {
        ...
        model.addAttribute("carritoCount", carritoService.countItemsInCarrito(usuarioAutenticado)); // Para la navbar
    ...
    public String confirmPayment(
        ...
        try {
            System.out.println("Valor recibido de metodoPago: " + metodoPago);
            Pago.MetodoPago metodoPagoEnum = Pago.MetodoPago.valueOf(metodoPago.trim().toUpperCase());
            ...
            return "redirect:/pago/exito"; // Redirigir a la nueva página de éxito de pago
