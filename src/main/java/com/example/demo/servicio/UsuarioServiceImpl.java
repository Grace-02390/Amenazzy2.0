...
public class UsuarioServiceImpl implements UsuarioService {
     ...
     * Si el usuario es nuevo o se proporciona una nueva contraseña, esta se hashea.
     * Si se edita un usuario y la contraseña está vacía, se mantiene la contraseña existente.
    ...
    public Usuario saveUsuario(Usuario usuario) {
        ...
        if (usuario.getId() != null) {
            ...
            // Si es un nuevo usuario, validar DNI y Correo y hashear contraseña
            if (existsByDni(usuario.getDni())) {
            ...
            usuario.setContrasena(passwordEncoder.encode(usuario.getContrasena())); // Hashear para nuevos usuarios
        }
